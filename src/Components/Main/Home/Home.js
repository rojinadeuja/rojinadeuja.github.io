...
const home = () => {
    ...
    return <div>
        <div className="connect-links">
            <a className="connect-link" target="_blank" href="https://www.linkedin.com/in/rojinadeuja/">LinkedIn</a>
            <span>{'    '}</span>
            <a className="connect-link" target="_blank" href="https://github.com/rojinadeuja">Github</a>
        </div>
        <div className="profile-section">
            <img className="profile-img" src="assets/profile.jpg"></img>
